...
MARKET_MAX_AGE_SECONDS = int(os.getenv("MARKET_MAX_AGE_SECONDS", "60"))
MARKET_MIN_AGE_SECONDS = int(os.getenv("MARKET_MIN_AGE_SECONDS", "1800"))
MAX_RESOLUTION_WINDOW_HOURS = int(os.getenv("MAX_RESOLUTION_WINDOW_HOURS", "48"))
